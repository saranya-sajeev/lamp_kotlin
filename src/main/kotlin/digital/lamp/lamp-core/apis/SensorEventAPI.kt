...
import digital.lamp.lamp-core.models.SensorEvent
...
import digital.lamp.lamp-core.infrastructure.ServerException
import digital.lamp.lamp-core.infrastructure.ServerError
import digital.lamp.lamp-core.infrastructure.MultiValueMap
import digital.lamp.lamp-core.infrastructure.RequestConfig
import digital.lamp.lamp-core.infrastructure.RequestMethod
import digital.lamp.lamp-core.infrastructure.ResponseType
import digital.lamp.lamp-core.infrastructure.Success
import digital.lamp.lamp-core.infrastructure.toMultiValue

class SensorEventAPI(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sensorEventCreate(participantId: kotlin.String, sensorEvent: SensorEvent) : kotlin.String {
        val localVariableBody: kotlin.Any? = sensorEvent
